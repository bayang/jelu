  ...
  <div>
    ...
    >
      ...
      >
        ...
        Choose first the author that will be modified and kept in database.
      </o-step-item>
      ...
      >
        ...
        Choose next the author you want to merge with the other.
      </o-step-item>
      ...
      >
        ...
        Use fields on the right author to complete the author on the left one, then merge.
      </o-step-item>
    </o-steps>
        ...
        <div v-if="rightHasImage">
          <o-field>
            <figure class="small-cover">
              ...
              >
              <span
                class="icon overlay-button pointy-hand"
    ...
    <div class="mt-2">
      <button
        class="button is-primary is-light mb-4"
