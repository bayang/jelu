...
class ReviewServiceTest(
    ...
    fun teardDown() {
        reviewService
            .find(null, null, null, null, null, Pageable.ofSize(200))
    ...
    fun testLifeCycle() {
        ...
        found =
            reviewService.find(
                ...
                null,
                null,
                LocalDate.ofInstant(oneYearBefore, ZoneId.systemDefault()).plusDays(1),
                null,
                Pageable.ofSize(200),
            )
        Assertions.assertEquals(1L, found.totalElements)
    ...
    fun testRatings() {
        ...
        val userBookByCriteria =
            bookService.findUserBookByCriteria(
                user().id!!,
                null,
                null,
                null,
        ...
        userBookByCriteriaSorted =
            bookService.findUserBookByCriteria(
                ...
                null,
                null,
                PageRequest.of(0, 20, Sort.by(Sort.Direction.DESC, "usrAvgRating")),
            )
        Assertions.assertEquals(2, userBookByCriteriaSorted.totalElements)
